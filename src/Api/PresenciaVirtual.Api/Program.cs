...
builder.Services.AddAuthorization(options => options.AddPermissionPolicies(["restaurant.orders.create", "restaurant.tables.create", "restaurant.orders.additem", "restaurant.orders.read", "restaurant.orders.close", "restaurant.menuitems.create", "restaurant.settings.update"]));
...
builder.Services.AddScoped<UpdateRestaurantSettingsHandler>();
